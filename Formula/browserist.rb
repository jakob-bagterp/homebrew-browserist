class Browserist < Formula
  ...
  url "https://github.com/jakob-bagterp/browserist/releases/download/v1.4.3/browserist-1.4.3.tar.gz"
  sha256 "726fd3e05841a2b0e938214702860e42df1623cd0f8258505794436ee76d074f"
  license "Apache-2.0"
